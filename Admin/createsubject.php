...
if(isset($_POST['save'])){
    ...
    $query=mysqli_query($conn,"select * from tblsubjects where subjectName ='$subjectName'");
    ...
    if($ret > 0){ 
        ...
        $query=mysqli_query($conn,"insert into tblsubjects(subjectName, subjectCode) value('$subjectName' , '$subjectCode')");
 ...
 if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "edit")
	{
        ...
        if(isset($_POST['update'])){
            ...
            $query=mysqli_query($conn,"update tblsubjects set subjectName='$subjectName' , subjectCode= '$subjectCode' where Id='$Id'");
                ...
                <div class="card-body">
                  <form method="post">
                    <div class="form-group row mb-3">
                      ...
                      <input type="text" class="form-control" name="subjectName" value="<?php echo $row['subjectName'];?>" id="exampleInputFirstName" placeholder="Subject Name">
                        </div>
                        <div class="col-xl-6">
                            <label class="form-control-label">Subject Code<span class="text-danger ml-2">*</span></label>
                      <input type="text" class="form-control" name="subjectCode" value="<?php echo $row['subjectCode'];?>" id="exampleInputFirstName" placeholder="Subject Code">
                        </div>
                    </div>
                      <?php
                    if (isset($Id))
